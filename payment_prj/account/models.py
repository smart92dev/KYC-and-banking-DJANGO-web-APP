...
class Account (models.Model):
    ...
    account_balance = models.DecimalField(max_digits=20,decimal_places=2,default=00.00)
    account_number = ShortUUIDField(unique=True,length=10,max_length=25, prefix="333", alphabet="1234567890")
    account_id = ShortUUIDField(unique=True,length=7, max_length=25, prefix="KON", alphabet="1234567890") #2175893745837
